# language: pt
  Funcionalidade: Aprender Cucumber
    ...
    Cenário: Deve incrementar o contador
      ...
      Então o valor do contador será 12

    Cenário: Deve calcular atrado no prazo de entrega
      Dado que o prazo é dia 05/04/2018
      Quando a entrega atrasar em 2 dias
      Então a entrega será efetuada em 07/04/2018

    Cenário: Deve calcular atrado no prazo de entrega
      Dado que o prazo é dia 10/05/2018
      Quando a entrega atrasar em 2 meses
      Então a entrega será efetuada em 10/07/2018
